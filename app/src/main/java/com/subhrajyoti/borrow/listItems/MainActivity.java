...
public class MainActivity extends AppCompatActivity implements View.OnLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewAdapter = new RecyclerViewAdapter(new ArrayList<HistoryModel>(), this);
        ...
        viewModel.getSongList().observe(MainActivity.this, new Observer<List<HistoryModel>>() {
            @Override
    ...
    public boolean onLongClick(View v) {
        HistoryModel borrowModel = (HistoryModel) v.getTag();
