...
public class AddActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private FavouritesViewModel addBorrowViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBorrowViewModel = ViewModelProviders.of(this).get(FavouritesViewModel.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (itemEditText.getText() == null || nameEditText.getText() == null)
                    ...
                    addBorrowViewModel.addBorrow(new HistoryModel(
